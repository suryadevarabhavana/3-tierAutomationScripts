#! /bin/bash
# Update System Packages and Stop Firewalld 
sudo yum update -y
sudo systemctl stop firewalld
sudo setsebool httpd_can_network_connect 1
#Set Hostname enable PasswordAuthentication
...
# Configure Git 
sudo su - devops -c "git config --global user.name 'Bhavanasuryadevar'"
sudo su - devops -c "git config --global user.email 'suryadevarabhavana@gmail.com'"
