#!/bin/bash
#Set SELinux Boolean for Apache to Allow Network Connections:
sudo setsebool -P httpd_can_network_connect 1
 
cd /opt/
 
#git clone https://gitlab.com/Bhavanasuryadevara/student-app.git
...
# git clone https://gitlab.com/Bhavanasuryadevara/static-project 
